...
/**
  ...
  * @license MIT
  */
(function(n,t){typeof exports=="object"&&typeof module!="undefined"?t(exports,require("vue")):typeof define=="function"&&define.amd?define(["exports","vue"],t):t(n.VueClassComponent={},n.Vue)})(this,function(n,t){"use strict";function l(n,t){r(n,t);Object.getOwnPropertyNames(t.prototype).forEach(function(i){r(n.prototype,t.prototype,i)});Object.getOwnPropertyNames(t).forEach(function(i){r(n,t,i)})}function r(n,t,i){var r=i?Reflect.getOwnMetadataKeys(t,i):Reflect.getOwnMetadataKeys(t);r.forEach(function(r){var u=i?Reflect.getOwnMetadata(r,t,i):Reflect.getOwnMetadata(r,t);i?Reflect.defineMetadata(r,u,n,i):Reflect.defineMetadata(r,u,n)})}function a(n){return function(t,i,r){var u=typeof t=="function"?t:t.constructor;u.__decorators__||(u.__decorators__=[]);typeof r!="number"&&(r=undefined);u.__decorators__.push(function(t){return n(t,i,r)})}}function v(){for(var i=[],n=0;n<arguments.length;n++)i[n]=arguments[n];return t.extend({mixins:i})}function y(n){var t=typeof n;return n==null||t!=="object"&&t!=="function"}function o(n){typeof console!="undefined"&&console.warn("[vue-class-component] "+n)}function p(n,i){var f=i.prototype._init,r,u;return i.prototype._init=function(){var r=this,i=Object.getOwnPropertyNames(n),t;if(n.$options.props)for(t in n.$options.props)n.hasOwnProperty(t)||i.push(t);i.forEach(function(t){t.charAt(0)!=="_"&&Object.defineProperty(r,t,{get:function(){return n[t]},set:function(i){n[t]=i},configurable:!0})})},r=new i,i.prototype._init=f,u={},Object.keys(r).forEach(function(n){r[n]!==undefined&&(u[n]=r[n])}),!(i.prototype instanceof t)&&Object.keys(u).length>0&&o("Component class must inherit Vue or its descendant class when class property is used."),u}function s(n,r){var f,e;r===void 0&&(r={});r.name=r.name||n._componentTag||n.name;f=n.prototype;Object.getOwnPropertyNames(f).forEach(function(n){if(n!=="constructor"){if(i.indexOf(n)>-1){r[n]=f[n];return}var t=Object.getOwnPropertyDescriptor(f,n);t.value!==void 0?typeof t.value=="function"?(r.methods||(r.methods={}))[n]=t.value:(r.mixins||(r.mixins=[])).push({data:function(){var i;return i={},i[n]=t.value,i}}):(t.get||t.set)&&((r.computed||(r.computed={}))[n]={get:t.get,set:t.set})}});(r.mixins||(r.mixins=[])).push({data:function(){return p(this,n)}});e=n.__decorators__;e&&(e.forEach(function(n){return n(r)}),delete n.__decorators__);var s=Object.getPrototypeOf(n.prototype),h=s instanceof t?s.constructor:t,o=h.extend(r);return w(o,n,h),u&&l(o,n),o}function w(n,t,i){Object.getOwnPropertyNames(t).forEach(function(r){var f,u,s;if(r!=="prototype"&&(f=Object.getOwnPropertyDescriptor(n,r),!f||f.configurable)){if(u=Object.getOwnPropertyDescriptor(t,r),!e){if(r==="cid")return;if(s=Object.getOwnPropertyDescriptor(i,r),!y(u.value)&&s&&s.value===u.value)return}h.indexOf(r)>=0&&o("Static property name '"+r+"' declared on class '"+t.name+"' conflicts with reserved property name of Vue internal. It may cause unexpected behavior of the component. Consider renaming the property.");Object.defineProperty(n,r,u)}})}function c(n){return typeof n=="function"?s(n):function(t){return s(t,n)}}var u,f,e,i,h;t=t&&t.hasOwnProperty("default")?t["default"]:t;u=typeof Reflect!="undefined"&&Reflect.defineMetadata&&Reflect.getOwnMetadataKeys;f={__proto__:[]};e=f instanceof Array;i=["data","beforeCreate","created","beforeMount","mounted","beforeDestroy","destroyed","beforeUpdate","updated","activated","deactivated","render","errorCaptured","serverPrefetch"];h=["cid","super","options","superOptions","extendOptions","sealedOptions","component","directive","filter"];c.registerHooks=function(n){i.push.apply(i,n)};n.default=c;n.createDecorator=a;n.mixins=v;Object.defineProperty(n,"__esModule",{value:!0})});
(function(n,t){typeof exports=="object"&&typeof module!="undefined"?t(exports,require("vue"),require("vue-class-component")):typeof define=="function"&&define.amd?define(["exports","vue","vue-class-component"],t):t(n["vue-property-decorator"]={},n.Vue,n.VueClassComponent)})(this,function(n,t,i){"use strict";function e(n){return i.createDecorator(function(t,i){typeof t.inject=="undefined"&&(t.inject={});Array.isArray(t.inject)||(t.inject[i]=n||i)})}function o(n){return i.createDecorator(function(t,i){var r=t.provide,u;typeof r=="function"&&r.managed||(u=t.provide,r=t.provide=function(){var n=Object.create((typeof u=="function"?u.call(this):u)||null);for(var t in r.managed)n[r.managed[t]]=this[t];return n},r.managed={});r.managed[i]=n||i})}function s(n,t){return t===void 0&&(t={}),i.createDecorator(function(i,r){(i.props||(i.props={}))[r]=t;i.model={prop:r,event:n||r}})}function h(n){return n===void 0&&(n={}),i.createDecorator(function(t,i){(t.props||(t.props={}))[i]=n})}function c(n,t){t===void 0&&(t={});var r=t.deep,f=r===void 0?!1:r,u=t.immediate,e=u===void 0?!1:u;return i.createDecorator(function(t,i){typeof t.watch!="object"&&(t.watch=Object.create(null));var r=t.watch;typeof r[n]!="object"||Array.isArray(r[n])?typeof r[n]=="undefined"&&(r[n]=[]):r[n]=[r[n]];r[n].push({handler:i,deep:f,immediate:e})})}function l(n){return function(t,i,r){i=f(i);var u=r.value;r.value=function(){for(var e,f,o=this,t=[],r=0;r<arguments.length;r++)t[r]=arguments[r];e=function(r){r!==undefined&&t.unshift(r);o.$emit.apply(o,[n||i].concat(t))};f=u.apply(this,t);a(f)?f.then(function(n){e(n)}):e(f)}}}function a(n){return n instanceof Promise||n&&typeof n.then=="function"}var r,u,f;t=t&&t.hasOwnProperty("default")?t["default"]:t;r="default"in i?i["default"]:i;u=/\B([A-Z])/g;f=function(n){return n.replace(u,"-$1").toLowerCase()};n.Component=r;n.Vue=t;n.Mixins=i.mixins;n.Inject=e;n.Provide=o;n.Model=s;n.Prop=h;n.Watch=c;n.Emit=l;Object.defineProperty(n,"__esModule",{value:!0})});
var __assign=this&&this.__assign||Object.assign||function(n){for(var t,r,i=1,u=arguments.length;i<u;i++){t=arguments[i];for(r in t)Object.prototype.hasOwnProperty.call(t,r)&&(n[r]=t[r])}return n};(function(n){if(typeof module=="object"&&typeof module.exports=="object"){var t=n(require,exports);t!==undefined&&(module.exports=t)}else typeof define=="function"&&define.amd?define(["require","exports","fetch-everywhere"],n):typeof window!="undefined"&&n(function(){},window["@servicestack/client"]={})})(function(n,t){"use strict";function ui(n){var t,i;if(typeof window!="undefined"){t=new FormData;for(i in n)t.append(i,n[i]);return t}}function fi(n){var i=this,t={},r;if(!n)return t;if(typeof n!="object")throw new Error("keys must be an Array of object keys");return r=Array.prototype.slice.call(n),r.forEach(function(n){i[n]&&(t[n]=i[n])}),t}function at(){var i=this.responseStatus||this.ResponseStatus,n;return i==null?undefined:(n=i.ErrorCode?t.sanitize(i):i,!n.errors||n.errors.length==0?n.message||n.errorCode:undefined)}function vt(n){var u=this.responseStatus||this.ResponseStatus,i,o,s,f,h,e,c,r;if(u==null)return undefined;if(i=u.ErrorCode?t.sanitize(u):u,o=t.toVarNames(n),o&&!(i.errors==null||i.errors.length==0)){for(s=o.map(function(n){return(n||"").toLowerCase()}),f=0,h=i.errors;f<h.length;f++)if(r=h[f],s.indexOf((r.fieldName||"").toLowerCase())!==-1)return undefined;for(e=0,c=i.errors;e<c.length;e++)if(r=c[e],s.indexOf((r.fieldName||"").toLowerCase())===-1)return r.message||r.errorCode}return i.message||i.errorCode||undefined}function ei(n){var i,r,u;return n==null?at.call(this):(i=this.responseStatus||this.ResponseStatus,i==null)?undefined:(r=i.ErrorCode?t.sanitize(i):i,r.errors==null||r.errors.length==0)?undefined:(u=r.errors.find(function(t){return(t.fieldName||"").toLowerCase()==n.toLowerCase()}),u?u.message||u.errorCode:undefined)}function yt(n,t,i){var u=document.createElement(n),r;if(i)for(r in i)it(u,oi[r]||r,i[r]);return t&&t.insertAfter&&t.insertAfter.parentNode.insertBefore(u,t.insertAfter.nextSibling),u}function pt(){var o=r(this,"data-invalid"),i,e;if(o){i=this.type==="checkbox"||this.type==="radio"||u(this,"form-check");e=i?si(this,"form-check"):null;i?f(e||this.parentElement,"is-invalid form-control"):f(this,"is-invalid");var n=this.nextElementSibling,t=n&&(r(n,"for")===this.id||n.tagName==="SMALL")?i?e||n.parentElement:n:this,s=t!=null&&t.nextElementSibling&&u(t.nextElementSibling,"invalid-feedback")?t.nextElementSibling:yt("div",{insertAfter:t},{className:"invalid-feedback"});s.innerHTML=o}}function si(n,t){while(n!=null&&!u(n,t))n=n.parentElement;return n}function hi(n){for(var i=(n||document).querySelectorAll("[data-invalid]"),t=0;t<i.length;t++)pt.call(i[t])}function ci(n,t){t===void 0&&(t=document);t.addEventListener("click",function(t){var o=t.target,i=r(o,"data-click"),e,f,u;if(i||(e=o.closest("[data-click]"),e&&(i=r(e,"data-click"))),i)if(f=i.indexOf(":"),f>=0){var s=i.substring(0,f),h=i.substring(f+1),u=n[s];u&&u.apply(t.target,h.split(","))}else u=n[i],u&&u.apply(t.target,[].slice.call(arguments))})}function li(n,t){n&&(t.model&&ii(n,t.model),n.onsubmit=function(i){return i.preventDefault(),t.type="bootstrap-v4",dt(n,t)})}function ai(n,i,e){var y,p,d,c,w,g,nt,ut,a,v;if(bt(n),i){i=t.sanitize(i);f(n,"has-errors");y=e&&e.type==="bootstrap-v4";p=__assign({},wt,e);e.messages&&(p.overrideMessages=!0);var b=p.errorFilter.bind(p),k=i.errors,h=n.querySelectorAll.bind(n);if(k&&k.length){for(d={},c={},h("input,textarea,select,button").forEach(function(n){var t=n,f=t.previousElementSibling,e=t.nextElementSibling,s=t.type==="radio"||t.type==="checkbox",o=(s?null:t.id)||r(t,"name"),i;o&&(i=o.toLowerCase(),d[i]=t,y||(u(f,"help-inline")||u(f,"help-block")?c[i]=f:(u(e,"help-inline")||u(e,"help-block"))&&(c[i]=e)))}),h(".help-inline[data-for],.help-block[data-for]").forEach(function(n){var t=r(n,"data-for").toLowerCase();c[t]=n}),w=0,g=k;w<g.length;w++){var l=g[w],rt=(l.fieldName||"").toLowerCase(),o=d[rt];(o&&(y?(nt=r(o,"type"),ut=nt==="radio"||nt==="checkbox",ut||f(o,"is-invalid"),it(o,"data-invalid",b(l.message,l.errorCode,"field"))):(f(o,"error"),f(o.parentElement,"has-error"))),a=c[rt],a)&&(f(a,"error"),a.innerHTML=b(l.message,l.errorCode,"field"),a.style.display="block")}h("[data-validation-summary]").forEach(function(n){var u=r(n,"data-validation-summary").split(","),t=vt.call(i,u);t&&(n.innerHTML=tt(t))})}else v=b(i.message||s(i.errorCode),i.errorCode,"summary"),y?h("[data-validation-summary]").forEach(function(n){return n.innerHTML=v[0]==="<"?v:tt(v)}):h(".error-summary").forEach(function(n){n.innerHTML=v;n.style.display="block"});return n}}function bt(n){o(n,"has-errors");var t=n.querySelectorAll.bind(n);t(".error-summary").forEach(function(n){n.innerHTML="";n.style.display="none"});t("[data-validation-summary]").forEach(function(n){n.innerHTML=""});t(".error").forEach(function(n){return o(n,"error")});t(".form-check.is-invalid [data-invalid]").forEach(function(n){rt(n,"data-invalid")});t(".form-check.is-invalid").forEach(function(n){return o(n,"form-control")});t(".is-invalid").forEach(function(n){o(n,"is-invalid");rt(n,"data-invalid")});t(".is-valid").forEach(function(n){return o(n,"is-valid")})}function kt(n){var i,u,s,f,o;if(n===void 0&&(n={}),i=this,u=r(i,"enctype")||e.UrlEncoded,u==e.MultiPart&&window.FormData===undefined)throw new Error("FormData Type is needed to send '"+e.MultiPart+"' Content Types");try{s=gt(i,u)}catch(h){throw new Error(""+(h.message||h));}return f=new Headers,f.set("Accept",e.Json),f.set("Content-Type",u),o={method:r(i,"method")||"POST",credentials:"include",mode:"cors",headers:f,body:s},n.requestFilter&&n.requestFilter(o),fetch(new Request(n.url||r(i,"action"),o)).catch(function(n){throw new Error("Network is unreachable ("+(n.message||n)+")");}).then(function(r){return(n.responseFilter&&n.responseFilter(r),!r.ok)?r.json().catch(function(){throw new Error("The request failed with "+(r.statusText||r.status));}).then(function(n){throw Object.assign.apply(Object,[new c].concat(t.sanitize(n)));}):(vi(i,r),yi(r))})}function vi(n,t){var u=t.headers.get("X-Location"),i;if(u&&(location.href=u),i=t.headers.get("X-Trigger"),i){var r=i.indexOf(":"),e=r>=0?i.substring(0,r):i,f=r>=0?i.substring(r+1):null;ti(n,e,f?[f]:[])}}function dt(n,t){function h(r,e){var o,s;e===void 0&&(e=null);e?ai(n,e.ResponseStatus||e.responseStatus,__assign({},t)):r&&(f(n,"has-errors"),o=i(".error-summary")[0],o&&(o.innerHTML=r),u&&(s=i("[data-validation-summary]")[0],s&&(s.innerHTML=tt(r))));t.error&&t.error.call(n,e);u&&i("[data-invalid]").forEach(function(n){return pt.call(n)})}var s,u,i,r,e,c;t===void 0&&(t={});s=t.type;u=s==="bootstrap-v4";bt(n);try{if(t.validate&&t.validate.call(n)===!1)return!1}catch(l){return!1}return i=n.querySelectorAll.bind(n),f(n,"loading"),r=t.onSubmitDisable==null?"[type=submit]":t.onSubmitDisable,e=r!=null&&r!="",e&&i(r).forEach(function(n){it(n,"disabled","disabled")}),c=t.submit||kt,c.call(n,t).then(function(i){return t.success&&t.success.call(n,i),!1}).catch(function(n){n.responseStatus?h(null,n):h(""+(n.message||n),null)}).finally(function(){o(n,"loading");e&&i(r).forEach(function(n){rt(n,"disabled")});t.complete&&t.complete.call(n)})}function yi(n){var i=n.headers.get("content-type"),r=i&&i.indexOf(e.Json)!==-1,t;return r?n.json():(t=n.headers.get("content-length"),t==="0"||t==null&&!r)?null:n.json()}function gt(n,i){return i===void 0&&(i=null),i===e.MultiPart?new FormData(n):i==e.Json?JSON.stringify(t.serializeToObject(n)):ni(n)}function ut(n,t,i){for(var u,r,e=n,o=e.elements.length,f=0;f<o;f++)if(r=e.elements[f],r.name&&!r.disabled&&r.type!="file"&&r.type!="reset"&&r.type!="submit"&&r.type!="button")if(r.type=="select-multiple")for(u=e.elements[f].options.length-1;u>=0;u--)r.options[u].selected&&i(t,r.name,r.options[u].value);else(r.type!="checkbox"&&r.type!="radio"||r.checked)&&i(t,r.name,r.value);return t}function ni(n){var t=ut(n,[],function(n,t,i){return typeof i=="string"?n.push(encodeURIComponent(t)+"="+encodeURIComponent(i)):null});return t.join("&").replace(/%20/g,"+")}function ti(n,t,i){var r;i===void 0&&(i=null);document.createEvent?(r=document.createEvent(t=="click"||t.startsWith("mouse")?"MouseEvents":"HTMLEvents"),r.initEvent(t,!0,!0),r.data=i,n.dispatchEvent(r)):(r=document.createEventObject(),n.fireEvent("on"+t,r))}function ii(n,i){var c,o,r,f,e,l,a,v,s,u,h;if(i){c=function(n){return n?n[0]===n[0].toUpperCase()?t.toCamelCase(n):n[0]===n[0].toLowerCase()?t.toPascalCase(n):n:n};for(o in i)if(r=i[o],(typeof r=="undefined"||r===null)&&(r=""),f=n.elements.namedItem(o)||n.elements.namedItem(c(o)),e=f,f){l=e.type||f[0].type;switch(l){case"radio":case"checkbox":for(a=f.length,u=0;u<a;u++)f[u].checked=r.indexOf(f[u].value)>-1;break;case"select-multiple":for(v=y(r)?r:[r],s=f,u=0;u<s.options.length;u++)s.options[u].selected=v.indexOf(s.options[u].value)>-1;break;case"select":case"select-one":e.value=r.toString()||r;break;case"date":h=t.toDate(r);h&&(e.value=h.toISOString().split("T")[0]);break;default:e.value=r}}}}var p,ft,c,w,et,b,ri,ot,st,l,k,d,g,i,ht,nt,a,v,s,ct,h,lt,y,wt,e;Object.defineProperty(t,"__esModule",{value:!0});n("fetch-everywhere");p=function(){function n(n){Object.assign(this,n)}return n}();t.ResponseStatus=p;ft=function(){function n(n){Object.assign(this,n)}return n}();t.ResponseError=ft;c=function(){function n(n){Object.assign(this,n)}return n}();t.ErrorResponse=c;w=function(){function n(){}return n.prototype.tryResolve=function(n){return new n},n}();t.NewInstanceResolver=w;et=function(){function n(){}return n.prototype.tryResolve=function(n){return n.instance||(n.instance=new n)},n}();t.SingletonInstanceResolver=et;b={onConnect:"ServerEventConnect",onHeartbeat:"ServerEventHeartbeat",onJoin:"ServerEventJoin",onLeave:"ServerEventLeave",onUpdate:"ServerEventUpdate"},function(n){n[n.CONNECTING=0]="CONNECTING";n[n.OPEN=1]="OPEN";n[n.CLOSED=2]="CLOSED"}(ri=t.ReadyState||(t.ReadyState={}));ot=function(){function n(n,i,r,u){r===void 0&&(r={});u===void 0&&(u=null);var f=this;if(this.channels=i,this.options=r,this.eventSource=u,this.onMessage=function(n){var i,o,v,u,tt,p,w,r;if(!f.stopped){i=f.options;typeof o=="undefined"&&(o={querySelectorAll:function(){return[]}});var it=o.querySelectorAll.bind(o),c=t.splitOnFirst(n.data," "),rt=null,a=c[0],k=t.splitOnFirst(a,"@");k.length>1&&(rt=k[0],a=k[1]);v=c[1];u=null;try{u=v?JSON.parse(v):null}catch(st){}if(c=t.splitOnFirst(a,"."),c.length<=1)throw"invalid selector format: "+a;var l=c[0],ut=c[1].replace(new RegExp("%20","g")," "),d=t.splitOnFirst(ut,"$"),e=d[0],g=d[1],nt=g&&it(g),h=nt&&nt[0],ft=parseInt(n.lastEventId),et=n.data,ot=b[e]||"ServerEventMessage",s={eventId:ft,data:et,type:ot,channel:rt,selector:a,json:v,body:u,op:l,target:d[0],cssSelector:g,meta:{}},y=typeof u=="object"?Object.assign({},s,u):s;if(!i.validate||i.validate(s)!==!1){if(tt=new Headers,tt.set("Content-Type","text/plain"),l==="cmd")if(e==="onConnect"){if(f.connectionInfo=y,typeof u.heartbeatIntervalMs=="string"&&(f.connectionInfo.heartbeatIntervalMs=parseInt(u.heartbeatIntervalMs)),typeof u.idleTimeoutMs=="string"&&(f.connectionInfo.idleTimeoutMs=parseInt(u.idleTimeoutMs)),Object.assign(i,u),r=i.handlers.onConnect,r&&(r.call(h||o.body,f.connectionInfo,s),f.stopped))return;i.heartbeatUrl&&(i.heartbeat&&clearInterval(i.heartbeat),i.heartbeat=setInterval(function(){if(f.eventSource.readyState===EventSource.CLOSED){clearInterval(i.heartbeat);var n=i.handlers.onStop;n!=null&&n.apply(f.eventSource);f.reconnectServerEvents({error:new Error("EventSource is CLOSED")});return}fetch(new Request(i.heartbeatUrl,{method:"POST",mode:"cors",headers:tt,credentials:f.serviceClient.credentials})).then(function(n){if(!n.ok)throw new Error(n.status+" - "+n.statusText);}).catch(function(n){return f.reconnectServerEvents({error:n})})},f.connectionInfo&&f.connectionInfo.heartbeatIntervalMs||i.heartbeatIntervalMs||1e4));i.unRegisterUrl&&typeof window!="undefined"&&(window.onunload=function(){return f.stop()});f.updateSubscriberUrl=i.updateSubscriberUrl;f.updateChannels((i.channels||"").split(","))}else p=e=="onJoin"||e=="onLeave"||e=="onUpdate",r=i.handlers[e],r?p?r.call(h||o.body,y):r.call(h||o.body,u,s):p||(w=i.receivers&&i.receivers.cmd,f.invokeReceiver(w,e,h,s,"cmd")),p&&(r=i.handlers.onCommand,r&&r.call(h||o.body,y));else l==="trigger"?f.raiseEvent(ut,s):l==="css"&&t.css(nt||it("body"),e,u);w=i.receivers&&i.receivers[l];f.invokeReceiver(w,e,h,s,l);b[e]||(r=i.handlers.onMessage,r&&r.call(h||o.body,y));i.onTick&&i.onTick()}}},this.onError=function(n){if(!f.stopped){n||(n=event);var t=f.options.onException;t!=null&&t.call(f.eventSource,n);f.options.onTick&&f.options.onTick()}},this.channels.length===0)throw"at least 1 channel is required";this.resolver=this.options.resolver||new w;this.eventStreamUri=t.combinePaths(n,"event-stream")+"?";this.updateChannels(i);this.serviceClient=new a(n);this.listeners={};this.withCredentials=!0;this.options.handlers||(this.options.handlers={})}return n.prototype.getEventSourceOptions=function(){return{withCredentials:this.withCredentials}},n.prototype.reconnectServerEvents=function(n){var f=this,t,i,r,u;if(n===void 0&&(n={}),!this.stopped){if(n.error)this.onError(n.error);return t=this.eventSource,i=n.url||this.eventStreamUri||t.url,this.options.resolveStreamUrl!=null&&(i=this.options.resolveStreamUrl(i)),r=this.EventSource?new this.EventSource(i,this.getEventSourceOptions()):new EventSource(i,this.getEventSourceOptions()),r.addEventListener("error",function(){return n.onerror||t.onerror||f.onError}),r.addEventListener("message",n.onmessage||t.onmessage||this.onMessage),u=this.options.onReconnect,u!=null&&u.call(r,n.error),t.removeEventListener&&(t.removeEventListener("error",this.onError),t.removeEventListener("message",this.onMessage)),t.close(),this.eventSource=r}},n.prototype.start=function(){var t=this,n;return this.stopped=!1,(this.eventSource==null||this.eventSource.readyState===EventSource.CLOSED)&&(n=this.eventStreamUri,this.options.resolveStreamUrl!=null&&(n=this.options.resolveStreamUrl(n)),this.eventSource=this.EventSource?new this.EventSource(n,this.getEventSourceOptions()):new EventSource(n,this.getEventSourceOptions()),this.eventSource.addEventListener("error",this.onError),this.eventSource.addEventListener("message",function(n){return t.onMessage(n)})),this},n.prototype.stop=function(){var n,t;return(this.stopped=!0,this.eventSource&&this.eventSource.close(),n=this.options,n&&n.heartbeat&&clearInterval(n.heartbeat),t=this.connectionInfo,t==null||t.unRegisterUrl==null)?new Promise(function(n){return n()}):(this.connectionInfo=null,fetch(new Request(t.unRegisterUrl,{method:"POST",mode:"cors",credentials:this.serviceClient.credentials})).then(function(n){if(!n.ok)throw new Error(n.status+" - "+n.statusText);}).catch(this.onError))},n.prototype.invokeReceiver=function(n,t,i,r){var e,u,f;if(n)if(typeof n=="function"&&(n=this.resolver.tryResolve(n)),t=t.replace("-",""),n.client=this,n.request=r,typeof n[t]=="function")n[t].call(i||n,r.body,r);else if(t in n)n[t]=r.body;else{e=t.toLowerCase();for(u in n)if(u.toLowerCase()==e){typeof n[u]=="function"?n[u].call(i||n,r.body,r):n[u]=r.body;return}f=n.noSuchMethod;typeof f=="function"&&f.call(i||n,r.target,r)}},n.prototype.hasConnected=function(){return this.connectionInfo!=null},n.prototype.registerHandler=function(n,t){return this.options.handlers||(this.options.handlers={}),this.options.handlers[n]=t,this},n.prototype.setResolver=function(n){return this.options.resolver=n,this},n.prototype.registerReceiver=function(n){return this.registerNamedReceiver("cmd",n)},n.prototype.registerNamedReceiver=function(n,t){return this.options.receivers||(this.options.receivers={}),this.options.receivers[n]=t,this},n.prototype.unregisterReceiver=function(n){return n===void 0&&(n="cmd"),this.options.receivers&&delete this.options.receivers[n],this},n.prototype.updateChannels=function(n){this.channels=n;var t=this.eventSource!=null?this.eventSource.url:this.eventStreamUri;this.eventStreamUri=t.substring(0,Math.min(t.indexOf("?"),t.length))+"?channels="+n.join(",")+"&t="+(new Date).getTime()},n.prototype.update=function(n,t){var f=typeof n=="string"?n.split(","):n,e=typeof t=="string"?t.split(","):t,r=[],u,i;for(u in this.channels)i=this.channels[u],(e==null||e.indexOf(i)===-1)&&r.push(i);if(f)for(u in f)i=f[u],r.indexOf(i)===-1&&r.push(i);this.updateChannels(r)},n.prototype.addListener=function(n,t){var i=this.listeners[n]||(this.listeners[n]=[]);return i.push(t),this},n.prototype.removeListener=function(n,t){var i=this.listeners[n],r;return i&&(r=i.indexOf(t),r>=0&&i.splice(r,1)),this},n.prototype.raiseEvent=function(n,t){var r=this,i=this.listeners[n];i&&i.forEach(function(n){try{n(t)}catch(i){r.onError(i)}})},n.prototype.getConnectionInfo=function(){if(this.connectionInfo==null)throw"Not Connected";return this.connectionInfo},n.prototype.getSubscriptionId=function(){return this.getConnectionInfo().id},n.prototype.updateSubscriber=function(n){var t=this;return n.id==null&&(n.id=this.getSubscriptionId()),this.serviceClient.post(n).then(function(){t.update(n.subscribeChannels,n.unsubscribeChannels)}).catch(this.onError)},n.prototype.subscribeToChannels=function(){for(var t,r=this,i=[],n=0;n<arguments.length;n++)i[n]=arguments[n];return t=new l,t.id=this.getSubscriptionId(),t.subscribeChannels=i,this.serviceClient.post(t).then(function(){r.update(i,null)}).catch(this.onError)},n.prototype.unsubscribeFromChannels=function(){for(var t,r=this,i=[],n=0;n<arguments.length;n++)i[n]=arguments[n];return t=new l,t.id=this.getSubscriptionId(),t.unsubscribeChannels=i,this.serviceClient.post(t).then(function(){r.update(null,i)}).catch(this.onError)},n.prototype.getChannelSubscribers=function(){var n=this,t=new d;return t.channels=this.channels,this.serviceClient.get(t).then(function(t){return t.map(function(t){return n.toServerEventUser(t)})}).catch(function(t){n.onError(t);return[]})},n.prototype.toServerEventUser=function(n){var r=n.channels,t=new g,i;t.userId=n.userId;t.displayName=n.displayName;t.profileUrl=n.profileUrl;t.channels=r?r.split(","):null;for(i in n)i!="userId"&&i!="displayName"&&i!="profileUrl"&&i!="channels"&&(t.meta==null&&(t.meta={}),t.meta[i]=n[i]);return t},n.UnknownChannel="*",n}();t.ServerEventsClient=ot;st=function(){function n(){}return n.prototype.noSuchMethod=function(){},n}();t.ServerEventReceiver=st;l=function(){function n(){}return n.prototype.createResponse=function(){return new k},n.prototype.getTypeName=function(){return"UpdateEventSubscriber"},n}();t.UpdateEventSubscriber=l;k=function(){function n(){}return n}();t.UpdateEventSubscriberResponse=k;d=function(){function n(){}return n.prototype.createResponse=function(){return[]},n.prototype.getTypeName=function(){return"GetEventSubscribers"},n}();t.GetEventSubscribers=d;g=function(){function n(){}return n}();t.ServerEventUser=g;i=function(){function n(){}return n.Get="GET",n.Post="POST",n.Put="PUT",n.Delete="DELETE",n.Patch="PATCH",n.Head="HEAD",n.Options="OPTIONS",n.hasRequestBody=function(n){return!(n==="GET"||n==="DELETE"||n==="HEAD"||n==="OPTIONS")},n}();t.HttpMethods=i;ht=function(){function n(){}return n.prototype.createResponse=function(){return new nt},n.prototype.getTypeName=function(){return"GetAccessToken"},n}();nt=function(){function n(){}return n}();t.GetAccessTokenResponse=nt;a=function(){function n(n){n===void 0&&(n="/");this.baseUrl=n;this.replyBaseUrl=t.combinePaths(n,"json","reply")+"/";this.oneWayBaseUrl=t.combinePaths(n,"json","oneway")+"/";this.mode="cors";this.credentials="include";this.headers=new Headers;this.headers.set("Content-Type","application/json");this.manageCookies=typeof document=="undefined";this.cookies={}}return n.prototype.setCredentials=function(n,t){this.userName=n;this.password=t},n.prototype.setBearerToken=function(n){this.bearerToken=n},n.prototype.get=function(n,t){return typeof n!="string"?this.send(i.Get,n,t):this.send(i.Get,null,t,this.toAbsoluteUrl(n))},n.prototype.delete=function(n,t){return typeof n!="string"?this.send(i.Delete,n,t):this.send(i.Delete,null,t,this.toAbsoluteUrl(n))},n.prototype.post=function(n,t){return this.send(i.Post,n,t)},n.prototype.postToUrl=function(n,t,r){return this.send(i.Post,t,r,this.toAbsoluteUrl(n))},n.prototype.postBody=function(n,t,r){return this.sendBody(i.Post,n,t,r)},n.prototype.put=function(n,t){return this.send(i.Put,n,t)},n.prototype.putToUrl=function(n,t,r){return this.send(i.Put,t,r,this.toAbsoluteUrl(n))},n.prototype.putBody=function(n,t,r){return this.sendBody(i.Put,n,t,r)},n.prototype.patch=function(n,t){return this.send(i.Patch,n,t)},n.prototype.patchToUrl=function(n,t,r){return this.send(i.Patch,t,r,this.toAbsoluteUrl(n))},n.prototype.patchBody=function(n,t,r){return this.sendBody(i.Patch,n,t,r)},n.prototype.sendAll=function(n){if(n.length==0)return Promise.resolve([]);var r=t.combinePaths(this.replyBaseUrl,t.nameOf(n[0])+"[]");return this.send(i.Post,n,null,r)},n.prototype.sendAllOneWay=function(n){if(n.length==0)return Promise.resolve(void 0);var r=t.combinePaths(this.oneWayBaseUrl,t.nameOf(n[0])+"[]");return this.send(i.Post,n,null,r).then(function(){return void 0})},n.prototype.createUrlFromDto=function(n,r){var u=t.combinePaths(this.replyBaseUrl,t.nameOf(r)),f=i.hasRequestBody(n);return f||(u=t.appendQueryString(u,r)),u},n.prototype.toAbsoluteUrl=function(n){return n.startsWith("http://")||n.startsWith("https://")?n:t.combinePaths(this.baseUrl,n)},n.prototype.createRequest=function(r){var a=this,f=r.method,s=r.request,u=r.url,h=r.args,c=r.body,e;u||(u=this.createUrlFromDto(f,s));h&&(u=t.appendQueryString(u,h));this.bearerToken!=null?this.headers.set("Authorization","Bearer "+this.bearerToken):this.userName!=null&&this.headers.set("Authorization","Basic "+n.toBase64(this.userName+":"+this.password));this.manageCookies&&(e=Object.keys(this.cookies).map(function(n){var t=a.cookies[n];return t.expires&&t.expires<new Date?null:t.name+"="+encodeURIComponent(t.value)}).filter(function(n){return!!n}),e.length>0?this.headers.set("Cookie",e.join("; ")):this.headers.delete("Cookie"));var l=new Headers(this.headers),v=i.hasRequestBody(f),o={url:u,method:f,mode:this.mode,credentials:this.credentials,headers:l,compress:!1};return v&&(o.body=c||JSON.stringify(s),typeof window!="undefined"&&c instanceof FormData&&l.delete("Content-Type")),this.requestFilter!=null&&this.requestFilter(o),o},n.prototype.createResponse=function(n,i){var s=this,u,r,f,e,o;if(!n.ok)throw n;if(this.manageCookies&&(u=[],n.headers.forEach(function(n,t){"set-cookie"==t.toLowerCase()&&u.push(n)}),u.forEach(function(n){var i=t.parseCookie(n);i&&(s.cookies[i.name]=i)})),this.responseFilter!=null&&this.responseFilter(n),r=i&&typeof i!="string"&&typeof i.createResponse=="function"?i.createResponse():null,typeof r=="string")return n.text().then(function(n){return n});if(f=n.headers.get("content-type"),e=f&&f.indexOf("application/json")!==-1,e)return n.json().then(function(n){return n});if(typeof Uint8Array!="undefined"&&r instanceof Uint8Array){if(typeof n.arrayBuffer!="function")throw new Error("This fetch polyfill does not implement 'arrayBuffer'");return n.arrayBuffer().then(function(n){return new Uint8Array(n)})}if(typeof Blob=="function"&&r instanceof Blob){if(typeof n.blob!="function")throw new Error("This fetch polyfill does not implement 'blob'");return n.blob().then(function(n){return n})}return(o=n.headers.get("content-length"),o==="0"||o==null&&!e)?r:n.json().then(function(n){return n})},n.prototype.handleError=function(n,i,r){var u=this,f;if(r===void 0&&(r=null),i instanceof Error)throw this.raiseError(n,i);if(i.bodyUsed)throw this.raiseError(i,v(i.status,i.statusText,r));return(f=typeof i.json=="undefined"&&i.responseStatus,f)?new Promise(function(n,t){return t(u.raiseError(null,i))}):i.json().then(function(n){var u=t.sanitize(n);if(!u.responseStatus)throw v(i.status,i.statusText,r);r!=null&&(u.type=r);throw u;}).catch(function(n){if(n instanceof Error||typeof window!="undefined"&&n instanceof window.DOMException)throw u.raiseError(i,v(i.status,i.statusText,r));throw u.raiseError(i,n);})},n.prototype.send=function(n,t,i,r){return this.sendRequest({method:n,request:t,args:i,url:r})},n.prototype.sendBody=function(n,i,r,u){var f=t.combinePaths(this.replyBaseUrl,t.nameOf(i));return this.sendRequest({method:n,request:r,body:typeof r=="string"?r:typeof window!="undefined"&&r instanceof FormData?r:JSON.stringify(r),url:t.appendQueryString(f,i),args:u,returns:i})},n.prototype.sendRequest=function(n){var t=this,u=this.createRequest(n),f=n.returns||n.request,r=null,e=function(){var i=t.createRequest(n);return t.urlFilter&&t.urlFilter(i.url),fetch(i.url,i).then(function(n){return t.createResponse(n,f)}).catch(function(n){return t.handleError(r,n)})};return this.urlFilter&&this.urlFilter(u.url),fetch(u.url,u).then(function(n){r=n;return t.createResponse(n,f)}).catch(function(n){var u,f,o;if(n.status===401){if(t.refreshToken)return u=new ht,u.refreshToken=t.refreshToken,f=t.refreshTokenUri||t.createUrlFromDto(i.Post,u),o=t.createRequest({method:i.Post,request:u,args:null,url:f}),fetch(f,o).then(function(n){return t.createResponse(n,u).then(function(n){return t.bearerToken=n.accessToken,e()})}).catch(function(n){return t.handleError(r,n,"RefreshTokenException")});if(t.onAuthenticationRequired)return t.onAuthenticationRequired().then(e)}return t.handleError(r,n)})},n.prototype.raiseError=function(n,t){return this.exceptionFilter!=null&&this.exceptionFilter(n,t),t},n}();t.JsonServiceClient=a;v=function(n,t,i){i===void 0&&(i=null);var r=new c;return i!=null&&(r.type=i),r.responseStatus=new p,r.responseStatus.errorCode=n&&n.toString(),r.responseStatus.message=t,r};t.toCamelCase=function(n){return n?n.charAt(0).toLowerCase()+n.substring(1):n};t.toPascalCase=function(n){return n?n.charAt(0).toUpperCase()+n.substring(1):n};t.sanitize=function(n){var r,i,u,s,f,e,o;if(n.responseStatus||n.errors)return n;r={};for(i in n)n.hasOwnProperty(i)&&(r[t.toCamelCase(i)]=n[i]instanceof Object?t.sanitize(n[i]):n[i]);if(r.errors=[],n.Errors!=null)for(u=0,s=n.Errors.length;u<s;u++){f=n.Errors[u];e={};for(o in f)e[t.toCamelCase(o)]=f[o];r.errors.push(e)}return r};t.nameOf=function(n){var t,i;if(!n)return"null";if(typeof n.getTypeName=="function")return n.getTypeName();if(t=n&&n.constructor,t==null)throw n+" doesn't have constructor";return t.name?t.name:(i=t.toString(),i.substring(9,i.indexOf("(")))};t.css=function(n,t,i){for(var r,f=typeof n=="string"?document.querySelectorAll(n):n,u=0;u<f.length;u++)r=f[u],r!=null&&r.style!=null&&(r.style[t]=i)};t.splitOnFirst=function(n,t){if(!n)return[n];var i=n.indexOf(t);return i>=0?[n.substring(0,i),n.substring(i+1)]:[n]};t.splitOnLast=function(n,t){if(!n)return[n];var i=n.lastIndexOf(t);return i>=0?[n.substring(0,i),n.substring(i+1)]:[n]};s=function(n){return typeof n!="string"?n:n.replace(/([A-Z]|[0-9]+)/g," $1").replace(/_/g," ").trim()};t.humanize=function(n){return!n||n.indexOf(" ")>=0?n:s(n)};t.queryString=function(n){var u,f,i,r;if(!n||n.indexOf("?")===-1)return{};for(u=t.splitOnFirst(n,"?")[1].split("&"),f={},i=0;i<u.length;++i)r=u[i].split("="),f[r[0]]=r.length>1?decodeURIComponent(r[1].replace(/\+/g," ")):null;return f};t.combinePaths=function(){for(var i,n,e,t,r,u,o=[],f=0;f<arguments.length;f++)o[f]=arguments[f];for(i=[],n=0,e=o.length;n<e;n++)t=o[n],i=t.indexOf("://")===-1?i.concat(t.split("/")):i.concat(t.lastIndexOf("/")===t.length-1?t.substring(0,t.length-1):t);for(r=[],n=0,e=i.length;n<e;n++)(u=i[n],u&&u!==".")&&(u===".."?r.pop():r.push(u));return i[0]===""&&r.unshift(""),r.join("/")||(r.length?"/":".")};t.createPath=function(n,t){var s={},e,o,r,u,i,f;for(e in t)s[e.toLowerCase()]=e;for(o=n.split("/"),r="",u=0;u<o.length;u++)i=o[u],i==null&&(i=""),i[0]==="{"&&i[i.length-1]==="}"&&(f=s[i.substring(1,i.length-1).toLowerCase()],f&&(i=t[f],delete t[f])),r.length>0&&(r+="/"),r+=i;return r};t.createUrl=function(n,i){var r=t.createPath(n,i);return t.appendQueryString(r,i)};t.appendQueryString=function(n,t){for(var i in t)t.hasOwnProperty(i)&&(n+=n.indexOf("?")>=0?"&":"?",n+=i+"="+ct(t[i]));return n};ct=function(n){return n==null?"":typeof Uint8Array!="undefined"&&n instanceof Uint8Array?t.bytesToBase64(n):encodeURIComponent(n)||""};t.bytesToBase64=function(n){for(var u=(3-n.length%3)%3,r="",f,e=n.length,t=0,i=0;i<e;i++)f=i%3,t|=n[i]<<(16>>>f&24),(f===2||n.length-i==1)&&(r+=String.fromCharCode(h(t>>>18&63),h(t>>>12&63),h(t>>>6&63),h(t&63)),t=0);return u===0?r:r.substring(0,r.length-u)+(u===1?"=":"==")};h=function(n){return n<26?n+65:n<52?n+71:n<62?n-4:n===62?43:n===63?47:65};lt=typeof btoa=="function"?btoa:function(n){return new Buffer(n).toString("base64")};a.toBase64=function(n){return lt(encodeURIComponent(n).replace(/%([0-9A-F]{2})/g,function(n,t){return String.fromCharCode(new Number("0x"+t).valueOf())}))};t.stripQuotes=function(n){return n&&n[0]=='"'&&n[n.length]=='"'?n.slice(1,-1):n};t.tryDecode=function(n){try{return decodeURIComponent(n)}catch(t){return n}};t.parseCookie=function(n){var i,e,r,f;if(!n)return null;for(i=null,e=n.split(/; */),r=0;r<e.length;r++){var h=e[r],o=t.splitOnFirst(h,"="),s=o[0].trim(),u=o.length>1?t.tryDecode(t.stripQuotes(o[1].trim())):null;r==0?i={name:s,value:u,path:"/"}:(f=s.toLowerCase(),f=="httponly"?i.httpOnly=!0:f=="secure"?i.secure=!0:f=="expires"?(i.expires=new Date(u),i.expires.toString()==="Invalid Date"&&(i.expires=new Date(u.replace(/-/g," ")))):i[s]=u)}return i};t.normalizeKey=function(n){return n.toLowerCase().replace(/_/g,"")};y=function(n){return Object.prototype.toString.call(n)==="[object Array]"};t.normalize=function(n,i){var f,r,e,u;if(y(n)){if(!i)return n;for(f=[],r=0;r<n.length;r++)f[r]=t.normalize(n[r],i);return f}if(typeof n!="object")return n;e={};for(u in n)e[t.normalizeKey(u)]=i?t.normalize(n[u],i):n[u];return e};t.getField=function(n,i){return n==null||i==null?null:n[i]||n[Object.keys(n).filter(function(n){return t.normalizeKey(n)===t.normalizeKey(i)})[0]||""]};t.parseResponseStatus=function(n,i){i===void 0&&(i=null);try{var u=JSON.parse(n);return t.sanitize(u.ResponseStatus||u.responseStatus)}catch(r){return{message:i||r.message||r,__error:{error:r,json:n}}}};t.toFormData=ui;t.toObject=fi;t.errorResponseSummary=at;t.errorResponseExcept=vt;t.errorResponse=ei;t.toDate=function(n){return n?typeof n.getMonth=="function"?n:n[0]=="/"?new Date(parseFloat(/Date\(([^)]+)\)/.exec(n)[1])):new Date(n):null};t.toDateFmt=function(n){return t.dateFmt(t.toDate(n))};t.padInt=function(n){return n<10?"0"+n:n};t.dateFmt=function(n){return n===void 0&&(n=new Date),n.getFullYear()+"/"+t.padInt(n.getMonth()+1)+"/"+t.padInt(n.getDate())};t.dateFmtHM=function(n){return n===void 0&&(n=new Date),n.getFullYear()+"/"+t.padInt(n.getMonth()+1)+"/"+t.padInt(n.getDate())+" "+t.padInt(n.getHours())+":"+t.padInt(n.getMinutes())};t.timeFmt12=function(n){return n===void 0&&(n=new Date),t.padInt((n.getHours()+24)%12||12)+":"+t.padInt(n.getMinutes())+":"+t.padInt(n.getSeconds())+" "+(n.getHours()>12?"PM":"AM")};var tt=function(n){return'<div class="alert alert-danger">'+n+"<\/div>"},r=function(n,t){return n.getAttribute(t)},it=function(n,t,i){return n.setAttribute(t,i)},rt=function(n,t){return n.removeAttribute(t)},oi={className:"class",htmlFor:"for"};t.createElement=yt;var u=function(n,t){return n?n.classList?n.classList.contains(t):(" "+n.className+" ").replace(/[\n\t\r]/g," ").indexOf(" "+t+" ")>-1:!1},f=function(n,t){return n?n.classList?(i=n.classList).add.apply(i,t.split(" ")):u(n,t)?null:n.className=(n.className+" "+t).trim():null;var i},o=function(n,t){return n?n.classList?n.classList.remove(t):u(n,t)?n.className=n.className.replace(/(\s|^)someclass(\s|$)/," "):null:null};t.bootstrap=hi;typeof window!="undefined"&&window.Element!==undefined&&(Element.prototype.matches||(Element.prototype.matches=Element.prototype.msMatchesSelector||Element.prototype.webkitMatchesSelector),Element.prototype.closest||(Element.prototype.closest=function(n){var t=this;do{if(t.matches(n))return t;t=t.parentElement||t.parentNode}while(t!==null&&t.nodeType===1);return null}));t.bindHandlers=ci;t.bootstrapForm=li;wt={overrideMessages:!1,messages:{NotEmpty:"Required",NotNull:"Required",Email:"Invalid email",AlreadyExists:"Already exists"},errorFilter:function(n,t){return this.overrideMessages?this.messages[t]||n||s(t):n||s(t)}};e={MultiPart:"multipart/form-data",UrlEncoded:"application/x-www-form-urlencoded",Json:"application/json"};t.toVarNames=function(n){return n?y(n)?n:n.split(",").map(function(n){return n.trim()}):[]};t.formSubmit=kt;t.ajaxSubmit=dt;t.serializeForm=gt;t.serializeToObject=function(n){return ut(n,{},function(n,t,i){return n[t]=i})};t.serializeToUrlEncoded=ni;t.serializeToFormData=function(n){return ut(n,new FormData,function(n,t,i){return n.append(t,i)})};t.triggerEvent=ti;t.populateForm=ii});
